...
const clone = require('./clone-e3883269.js');

var momentTimezone = timestepUtils.createCommonjsModule(function (module) {
//! moment-timezone.js
//! version : 0.5.31
...
(function (root, factory) {
	...
	/*global define*/
	if ( module.exports) {
		module.exports = factory(timestepUtils.hooks); // Node
	} else {
		factory(root.moment);                        // Browser
	}
}(timestepUtils.commonjsGlobal, function (moment) {
...
const BaseTimeline = class {
    ...
    mouseLeaveHandler(event) {
        const newMouseState = clone.clone_1(this.mouseState);
    ...
    componentDidLoad() {
        ...
        new ResizeSensor.ResizeSensor(this.element.firstElementChild, () => {
    ...
    render() {
        return (index.h("div", { class: 'timelineContainer_normalView' }, index.h("div", { class: 'timelineContainer__controlBar' }, index.h("div", { class: 'timelineContainer__controlBar__playButtons' }, !this.isMobileScreen() &&
            index.h("play-buttons", { playing: this.playing, "disable-play-button": this.disablePlayButton })), index.h("div", { class: 'timelineContainer__controlBar__dateLabel' }, this.dateLabel((this.isMobileScreen()) ? 'ddd HH:mm zz' : this.dateLabelFormat)), index.h("div", { class: 'timelineContainer__controlBar__slot' }, index.h("slot", null))), this.timeStepArray.length > 0 &&
            index.h("div", { class: 'timelineContainer__timeline' }, this.isMobileScreen() ? (this.renderMobileTimeline()) : (this.renderTimeline()))));
    }
    ...
    dateLabel(momentFormat) {
        const timezones = momentTimezone$1.tz.names();
    ...
    renderMobileTimeline() {
        ...
        this.constrainTimeline = false;
        return (index.h("mobile-timeline", { timeSteps: this.timeStepArray, disableTimesteps: this.disableTimesteps, loadedTimeStepMap: this.loadedTimeStepMap, timeStepIndex: this.timeStepIndex }));
    }
    renderTimeline() {
        return (index.h("time-line", { timeSteps: this.timeStepArray, disableTimesteps: this.disableTimesteps, loadedTimeStepMap: this.loadedTimeStepMap, timeStepIndex: this.timeStepIndex, labelFormat: this.timeLineLabelFormat, warnings: this.warnings, mouseState: this.mouseState, constrainTimeline: this.constrainTimeline }));
    }
    startTimer() {
...
exports.mo_timeline = BaseTimeline;
