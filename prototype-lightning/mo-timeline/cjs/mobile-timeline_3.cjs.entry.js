...
var momentumSlider = timestepUtils.createCommonjsModule(function (module, exports) {
/* eslint-disable */
(function (global, factory) {
     module.exports = factory() ;
}(timestepUtils.commonjsGlobal, (function () {
    /* eslint-enable */
...
const MobileTimeline = class {
    constructor(hostRef) {
        ...
        this.newIndexSelected = index.createEvent(this, "newIndexSelected", 7);
...
const PlayButtons = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.forwardClicked = index.createEvent(this, "forwardClicked", 7);
        this.backClicked = index.createEvent(this, "backClicked", 7);
        this.playPauseClicked = index.createEvent(this, "playPauseClicked", 7);
    ...
    render() {
        return (index.h("div", { class: 'buttonsContainer', role: 'controlbuttons' }, index.h("button", { class: 'buttonsContainer__button back', title: 'Back', "aria-label": 'Back', onClick: () => {
                this.handleBackClick();
            } }, index.h("svg", { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 512 512' }, index.h("path", { d: 'M249.6 402V110L32 256l217.6 146zm12.8-146L480 402V110L262.4 256z', fill: '#B9DC0C' }))), this.disablePlayButton ?
            index.h("button", { class: 'buttonsContainer__button play', title: 'Play Button Disabled', "aria-label": 'Play Button Disabled' }, index.h("svg", { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 512 512' }, index.h("path", { d: 'M96 52v408l320-204L96 52z', fill: '#A1A0AA', opacity: '0.75' }))) :
            index.h("button", { class: 'buttonsContainer__button play', title: this.playing ? 'Pause' : 'Play', "aria-label": 'PlayPause', onClick: () => {
                    this.handlePlayPauseClick();
                } }, (this.playing) ?
                index.h("svg", { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 512 512' }, index.h("path", { d: 'M96 448h106.7V64H96v384zM309.3 64v384H416V64H309.3z', fill: '#B9DC0C' }))
                :
                    index.h("svg", { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 512 512' }, index.h("path", { d: 'M96 52v408l320-204L96 52z', fill: '#B9DC0C' }))), index.h("button", { class: 'buttonsContainer__button forward', title: 'Forward', "aria-label": 'Forward', onClick: () => {
                this.handleForwardClick();
            } }, index.h("svg", { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 512 512' }, index.h("path", { d: 'M480 256L262.4 110v292L480 256zM32 110v292l217.6-146L32 110z', fill: '#B9DC0C' })))));
    }
    handleBackClick() {
...
const Timeline = class {
    ...
    render() {
        if (this.timeSteps) {
            return (index.h("div", { class: 'timesteps' }, index.h("time-slider", { timeSteps: this.timeSteps, timeStepProperties: this.timeStepProperties, loadedTimeStepMap: this.loadedTimeStepMap, timeStepIndex: this.timeStepIndex, disableTimesteps: this.disableTimesteps, mouseState: this.mouseState, constrainTimeline: this.constrainTimeline }), (this.warnings && this.warnings.length > 0) &&
                index.h("timeline-warnings", { firstTimeStep: this.timeSteps[0], lastTimeStep: this.timeSteps[this.timeSteps.length - 1], warnings: this.warnings }), this.timeSteps.map((timeStep, index$1) => {
                return (index.h("time-step", { timeData: this.generateTimeStepProp(timeStep, index$1, this.constrainTimeline), labelFormat: this.labelFormat }));
            })));
        }
        else {
            return null;
    ...
    generateTimeStepProp(time, timeStepIndex, constrainTimeline) {
        ...
        if (timeStepProperty === null || typeof timeStepProperty === 'undefined') {
            const timeStep = timestepUtils.hooks(time);
            const previousTimeStep = (timeStepIndex > 0) ? timestepUtils.hooks(this.timeSteps[timeStepIndex - 1]) : undefined;
            const maxIndex = this.timeSteps.length - 1;
            const nextTimeStep = (timeStepIndex < maxIndex) ? timestepUtils.hooks(this.timeSteps[timeStepIndex + 1]) : undefined;
            timeStepProperty = {
                nextTimeStep,
                timeStep,
                previousTimeStep,
        ...
        if (timeStepEnabled !== timeStepProperty.enabled) {
            ...
            timeStepProperty = clone.clone_1(timeStepProperty);
        }
...
exports.mobile_timeline = MobileTimeline;
exports.play_buttons = PlayButtons;
exports.time_line = Timeline;
